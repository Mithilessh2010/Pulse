        ...
        >
          <div className="rounded-[20px] border border-white/[0.06] bg-[#07090F]/45 p-4">
            ...
            <div className="mt-4 flex gap-2">
              <button className="rounded-lg bg-emerald-400/90 px-3 py-2 text-xs font-semibold text-[#06110A]">Approve</button>
              <button className="rounded-lg border border-white/10 bg-white/[0.035] px-3 py-2 text-xs font-medium text-[#C8D0E8]">Request Changes</button>
            </div>
          </div>
        </FeatureMockShell>
